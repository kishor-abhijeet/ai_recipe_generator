...
class Recipe {
  ...
  static async create(userId, recipeData) {
    ...
    static async update(id, userId, updates) {
        ...
        RETURNING *`,
        [userId, name, description, cuisine_type, difficulty, prep_time, cook_time, servings,
            instructions?  JSON.stringify(instructions): null, dietary_tags, user_notes, image_url]
        );
